<div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header text-white" style="background-color: #ff1493;">
            ...
            <div class="modal-body m-3">
                <form method="get" action="">
                    <div class="text-center">
                        <img class="img-thumbnail rounded-circle" src="<?php echo BASE_URL . 'assets/img/LogoPerla.png'; ?>" alt="" width="100">
                    </div>
                    <div class="row">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 pt-5">
                <h2 class="h2 text-success border-bottom pb-3 border-light logo">Afrodita Shop</h2>
                <ul class="list-unstyled text-light footer-link-list">
                    ...
                    <li>
                        ...
                        <a class="text-decoration-none" href="mailto:info@company.com">Afrodita@company.com</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-md-4 pt-5">
                ...
                <ul class="list-unstyled text-light footer-link-list">
                    ...
                    <li><a class="text-decoration-none" href="<?php echo BASE_URL . 'principal/about' ?>">Servicios</a></li>
            ...
            <div class="row pt-2">
                <div class="col-12">
                    <p class="text-left text-light">
                        ...
                        | Designed by <a rel="sponsored" href="#" target="_blank">LPO</a>
                    </p>
                </div>
            </div>
        </div>
